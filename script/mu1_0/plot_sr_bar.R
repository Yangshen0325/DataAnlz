...
all_paths <- c("script/mu1_0/l0_0l1_0/",
               "script/mu1_0/l0_0.1l1_0/",
               "script/mu1_0/l0_1l1_0/",
               "script/mu1_0/l0_0l1_0.01/",
               "script/mu1_0/l0_0.1l1_0.01/",
               "script/mu1_0/l0_1l1_0.01/",
               "script/mu1_0/l0_0l1_0.1/",
               "script/mu1_0/l0_0.1l1_0.1/",
               "script/mu1_0/l0_1l1_0.1/"
              )
...
# 02 Plot
  ...
  scenario_labels <- c(
    "script/mu1_0/l0_0l1_0/" = "lambda[0] == 0 ~ ',' ~ lambda[1]^a == 0",
    "script/mu1_0/l0_0.1l1_0/" = "lambda[0] == 0.1 ~ ',' ~ lambda[1]^a == 0",
    "script/mu1_0/l0_1l1_0/" = "lambda[0] == 1.0 ~ ',' ~ lambda[1]^a == 0",
    "script/mu1_0/l0_0l1_0.01/" = "lambda[0] == 0 ~ ',' ~ lambda[1]^a == 0.01",
    "script/mu1_0/l0_0.1l1_0.01/" = "lambda[0] == 0.1 ~ ',' ~ lambda[1]^a == 0.01",
    "script/mu1_0/l0_1l1_0.01/" = "lambda[0] == 1.0 ~ ',' ~ lambda[1]^a == 0.01",
    "script/mu1_0/l0_0l1_0.1/" = "lambda[0] == 0 ~ ',' ~ lambda[1]^a == 0.1",
    "script/mu1_0/l0_0.1l1_0.1/" = "lambda[0] == 0.1 ~ ',' ~ lambda[1]^a == 0.1",
    "script/mu1_0/l0_1l1_0.1/" = "lambda[0] == 1.0 ~ ',' ~ lambda[1]^a == 0.1"
  )
 ...
 p  <- ggplot(plot_data, aes(x = effects, y = value, fill = species)) +
  ...
  ggsave("script/mu1_0/plot_sr_bar.png", p, width = 8, height = 8, units = "in",
         dpi = 300)
